...
public:
    ...
    ParallelSimulateStacksCardiac4D(irtkReconstructionCardiac4D *_reconstructor) : 
    reconstructor(_reconstructor) { }
...
// Simulate Stacks
// -----------------------------------------------------------------------------
void irtkReconstructionCardiac4D::SimulateStacksCardiac4D(vector<bool> stack_excluded)
{
