...
void usage()
{
  cerr << "Usage: simulateStacks [volume] [N] [stack_1] .. [stack_N] <options>\n" << endl;
  cerr << endl;

  cerr << "\t[volume]                Input volume. Nifti or Analyze format." << endl;
  cerr << "\t[N]                     Number of stacks." << endl;
  cerr << "\t[stack_1] .. [stack_N]  The grid for simulated stacks. Nifti or Analyze format." << endl;
